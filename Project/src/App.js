...
class App extends Component {
  ...
  login() {
    ...
    email === "laakshmi@gmail.com" && password === "laakshmi" ? this.setState({
      user:{
        email : email,
        password : password    
      }
  ...
  renderHeader(){
    return(
      <header className="App-header">
        <b><h1 className="App-title">Welcome To Employee Management System</h1></b>
      </header>
    )
  }
    ...
    return(
      <div className="loginForm">
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" id="profession" aria-describedby="emailHelp" placeholder="Enter profession"/>
        </div>
        <div className="form-group">
          <label >Salary</label>
